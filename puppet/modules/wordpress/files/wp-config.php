 ...
 *
 * Overwrite the URLs in the database. This shouldn't need changing other than
 * inn the Staging site config file.
 */
define('WP_HOME','http://vagrantpress.dev');
define('WP_SITEURL','http://vagrantpress.dev');
...
/**
 * Temporary folder for Crimeline Book files.
 **/
define('CLT_BOOK_PDF_DIR', '/vagrant/wordpress/wp-content/books/');
